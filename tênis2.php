...
<body>
	...
	<p style="color: black; font-family: arial; font-size: 50px; margin-left: 800px;">
		Air force Travis Scott <br>
		R$00,00
	</p>
	...
	<br>
		...
		<div class="tamanho_quantidade">
			<div class="P">
				<center>
					<a value="Tamanho P">35 </a>
				</center>
		</div>

		<div class="PP">
			<center>
				<option value="Tamanho PP">38</option>
			</center>
		</div>

		<div class="M">
			<center>
				<option value="Tamanho M">40 </option>
			</center>
		</div>

		<div class="G">
			<center>
				<option value="Tamanho G">41 </option>
			</center>
		</div>

		<div class="GG">
			<center>
				<option value="Tamanho GG">43 </option>
			</center>
		</div>

		<div class="tamanho_quantidade">
			<input class="input_quantidade" type="number" name="">
		</div>
