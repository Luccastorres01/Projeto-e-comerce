...
<head>
	...
	<title>www.CCLAUS.com.br/CALÇADOS</title>
</head>
<body>
	...
	<!--Conteúdo da página-->
	<center>
		<h1 style="font-family: arial;">CALÇADOS</h1>
	</center>

	<div class="produtos">
				<center>
					<a href="bota1.php" style="text-decoration: none; font-family: arial; font-size: 20px; color: black;">
						<img src="Calçados_botas1.jpg" style="width: 250px; height: 250px;">
						<p>Bota couro marrom<br>R$000,00</p>
					</a>
				</center>
			</div>
			...
			<div class="produtos">
				<center>
					<a href="tênis2.php" style="text-decoration: none; font-family: arial; font-size: 20px; color: black;">
						<img src="Calçados_tenis2.webp" style="width: 250px; height: 250px;">
						<p>Air force Travis Scott<br>R$000,00</p>
					</a>
				</center>
			</div>
			...
			<div class="produtos">
				<center>
					<a href="sapato1.php" style="text-decoration: none; font-family: arial; font-size: 20px; color: black;">
						<img src="Calçados_sapatos1.jpg" style="width: 250px; height: 250px;">
						<p>Sapato social Oxford<br>R$000,00</p>
					</a>
				</center>
			</div>
