...
<head>
	...
	<title>www.CCLAUS.com.br/BOLSAS</title>
</head>
<body>
	...
	<!--Conteúdo da página-->
	<center>
		<h1 style="font-family: arial;">BOLSAS</h1>
	</center>

	<div class="produtos">
				<center>
					<a href="mochila1.php" style="text-decoration: none; font-family: arial; font-size: 20px; color: black;">
						<img src="Bolsas_mochilas1.jpg" style="width: 250px; height: 250px;">
						<p>Mochila anti furto<br>R$000,00</p>
					</a>
				</center>
			</div>
			...
			<div class="produtos">
				<center>
					<a href="mala2.php" style="text-decoration: none; font-family: arial; font-size: 20px; color: black;">
						<img src="Bolsas_malas2.jpg" style="width: 250px; height: 250px;">
						<p>Mala marrom de couro<br>R$000,00</p>
					</a>
				</center>
			</div>
				...
				<div class="produtos">
				<center>
					<a href="necessérie3.php" style="text-decoration: none; font-family: arial; font-size: 20px; color: black;">
						<img src="Bolsas_necessérie3.png" style="width: 300px; height: 250px;">
						<p>Necessaire simples preta<br>R$000,00</p>
					</a>
				</center>
			</div>
