...
<head>
	...
	<title>www.CCLAUS.com.br/ROUPAS</title>
</head>
<body>
	...
	<!--Conteúdo da página-->
		<center>
			<h1 style="font-family: arial;">ROUPAS</h1>
		</center>
			...
			<div class="produtos">
				<center>
					<a href="calça1.php" style="text-decoration: none; font-family: arial; font-size: 20px; color: black;">
						<img src="Roupas_calças1.webp" style="width: 250px; height: 250px;">
						<p>Calça social<br>R$000,00</p>
					</a>
				</center>
			</div>
			...
			<div class="produtos">
				<center>
					<a href="casaco3.php" style="text-decoration: none; font-family: arial; font-size: 20px; color: black;">
						<img src="Roupas_casacos3.webp" style="width: 250px; height: 250px;">
						<p>Jaqueta<br>R$000,00</p>
					</a>
				</center>
			</div>
